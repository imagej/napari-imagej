...
For this use case we will analyze `live cell wide-field microscopy data of HeLa cell nuclei <https://media.imagej.net/napari-imagej/trackmate_example_data.tif>`_ (Hoechst stain), imaged every 30 minutes for 40 frames.
...
- **LoG detector**
    ...
    .. figure:: https://media.imagej.net/napari-imagej/trackmate_detector_preview.png
...
.. _Fiji: https://fiji.sc/
.. _trackmate_example_data.tif: https://media.imagej.net/napari-imagej/trackmate_example_data.tif
